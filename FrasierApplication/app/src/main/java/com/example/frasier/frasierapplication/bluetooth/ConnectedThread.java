package com.example.frasier.frasierapplication.bluetooth;

/**
* Created by frasier on 2/28/15.
* adapted from RIVeR-LAB google_glass_driver
* https://github.com/RIVeR-Lab/google_glass_driver/blob/master/android/RobotManager/src/com/riverlab/robotmanager/bluetooth/ConnectedThread.java
*/
...
import com.example.frasier.frasierapplication.MainActivity;
...

{
    ...
    public void start() {
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case CONNECT_MESSAGE:
                        ...
                        Log.d("ConnectedThread", "Connect request received");
                        connect(deviceName);
                        break;
                    ...
                    case WRITE_MESSAGE:
                        ...
                        Log.d("WriteMessage", "Test1");
                        break;
                    case SHUTDOWN_MESSAGE:
                        // shutdown();
                        Log.d("Shutdown", "ShutdownMessage");
                        break;
                }
            }
        };
     ...
     // Looper.loop(); //loops until "quit()" is called
